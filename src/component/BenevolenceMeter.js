...
export default function BenevolenceMeter() {
  return (
    <div className=" h-screen flex items-center justify-center mb-16">
      <div className="text-white flex flex-col justify-center items-center gap-y-5">
        ...
        <h2
          className=" drop-shadow-drop-green text-4xl font-bold bg-gradient-to-r from-left-gradient to-right-gradient inline-block text-transparent bg-clip-text"
        >
          Rewarder
        </h2>
